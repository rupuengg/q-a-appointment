    ...
    public function ajax_register_appointment() {
        try {
            ...
            try {
                ...
                if ($send_provider === TRUE) {
										// Change For CST
										$start_datetime = new DateTime($appointment['start_datetime']);
										$start_datetime->setTimezone(new DateTimeZone('CST'));
										$appointment['start_datetime'] = $start_datetime->date;

										$end_datetime = new DateTime($appointment['end_datetime']);
										$end_datetime->setTimezone(new DateTimeZone('CST'));
										$appointment['end_datetime'] = $end_datetime->date;
										// Change For CST End
